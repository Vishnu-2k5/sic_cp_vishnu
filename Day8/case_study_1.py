...
top_run_scorers = df[['Player_Name', 'Team', 'Runs']].sort_values(by='Runs', ascending=False).head(5)
print(top_run_scorers)

# Plot top 5 run scorers
plt.figure(figsize=(8,5))
sns.barplot(data=top_run_scorers, x="Runs", y="Player_Name", palette="viridis")
...
top_wicket_takers = df[['Player_Name', 'Team', 'Wickets']].sort_values(by='Wickets', ascending=False).head(5)
print(top_wicket_takers)

# Plot top 5 wicket takers
plt.figure(figsize=(14,5))
sns.barplot(data=top_wicket_takers, x="Wickets", y="Player_Name", palette="coolwarm")
